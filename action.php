...
$company_name->appendChild($dom->createTextNode($dataArray['company_name']));
$web_user = $customer_detail->appendChild($dom->createElement('WEB_USER'));
$web_user->appendChild($dom->createTextNode($dataArray['web_user']));
$mailing_status = $customer_detail->appendChild($dom->createElement('MAILING_STATUS'));
$mailing_status->appendChild($dom->createTextNode($dataArray['mailing_status']));
$company_class = $customer_detail->appendChild($dom->createElement('COMPANY_CLASS'));
$company_class->appendChild($dom->createTextNode($dataArray['company_class']));
$company_type = $customer_detail->appendChild($dom->createElement('COMPANY_TYPE'));
$company_type->appendChild($dom->createTextNode($dataArray['company_type']));
$company_code = $customer_detail->appendChild($dom->createElement('COMPANY_CODE'));
$company_code->appendChild($dom->createTextNode($dataArray['company_code']));
